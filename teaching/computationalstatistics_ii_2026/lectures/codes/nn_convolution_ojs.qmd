```{=html}
<div id="nn-convolution-mount"></div>
<script>
(() => {
  const template = document.createElement('template');
  template.innerHTML = `<div style="max-width:1000px;margin:auto;font-family:sans-serif">
  ...
  draw();
  document.getElementById('nn-convolution-mount').append(root);
})();
</script>
```
