```{=html}
<div id="nn-relu-mount"></div>
<script>
(() => {
  const template = document.createElement('template');
  template.innerHTML = `<div style="max-width:1100px;margin:0 auto;font-family:sans-serif;">
  ...
  update();
  document.getElementById('nn-relu-mount').append(container);
})();
</script>
```
